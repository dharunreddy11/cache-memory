...
# Generated on: Fri Oct 31 12:46:28 IST 2025 (Fri Oct 31 07:16:28 UTC 2025)
...
set_log_file fv/cache_memory/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/cache_memory -revised fv_map
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  cache_design.v
elaborate_design -golden -root {cache_memory} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/cache_memory/fv_map.v.gz
elaborate_design -revised -root {cache_memory}
...
#add_name_alias fv/cache_memory/fv_map.singlebit.original_name.alias.json.gz -revised
...
set lec_version_required "19.10100"
if {$lec_version >= $lec_version_required} {
analyze_results -logfiles fv/cache_memory/rtl_to_fv_map.log
}
